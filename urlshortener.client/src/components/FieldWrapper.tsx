import {cloneElement, type FC, forwardRef, type ReactElement, type ReactNode, useImperativeHandle, useRef} from "react";
...
export const InputValidationWrapper = forwardRef<HTMLSpanElement, IInputWrapperProps>(
    ({title, icon, className, children }, forwardedRef) => {
        ...
        const onValidate = (value: string) => ref.current!.innerText = value || "";
